...
// Settings for Watson Discovery service
const watsonDiscoveryCredentials = {
    username: process.env.WDS_USERNAME,
    password: process.env.WDS_PASSWORD,
    version: 'v1',
